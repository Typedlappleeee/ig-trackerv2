...
module.exports = async (req, res) => {
  ...
  const { op, agentUrl, agentToken, id, name, androidVersion, cmd, timeout, url, pkg, proxy } = req.body ?? {}
  ...
  try {
    ...
    switch (op) {
      ...
      case 'proxycheck':   r = await relay(agentUrl, agentToken, '/proxy/check', 'POST', proxy, 30000); break
