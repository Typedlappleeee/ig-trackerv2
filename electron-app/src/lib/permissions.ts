...
const ROLE_TABS: Record<OrgRole, Record<PageKey, boolean>> = {
  owner: {
    ...
    bank: true, videoimport: true, autocomment: true, warmup: true, aitools: true, montage: true, remix: true, repurpose: true, settings: true,
  },
  admin: {
    phones: true, posting: true, massposting: true, scheduler: true,
    bank: true, videoimport: true, autocomment: true, warmup: true, aitools: true, montage: true, remix: true, repurpose: true, settings: true,
  ...
  member: {
    phones: true, posting: true, massposting: true, scheduler: true,
    bank: true, videoimport: true, autocomment: true, warmup: true, aitools: true, montage: true, remix: true, repurpose: true, settings: false,
  },
  viewer: {
    phones: true, posting: false, massposting: false, scheduler: false,
    bank: true, videoimport: false, autocomment: false, warmup: false, aitools: false, montage: false, remix: false, repurpose: false, settings: false,
  },
}
