...
const ROLE_TABS: Record<OrgRole, Record<PageKey, boolean>> = {
  owner: {
    dashboard: true, phones: true, monitor: true, stats: true, posting: true, massposting: true, scheduler: true,
  ...
  viewer: {
    dashboard: true, phones: true, monitor: false, stats: true, posting: false, massposting: false, scheduler: false,
