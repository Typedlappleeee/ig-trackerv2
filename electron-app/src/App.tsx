  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" overflow="visible" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        stroke="#6366F1" strokeWidth="24" strokeLinecap="round" fill="none" opacity="0.3"
      />
      {/* Main S */}
      <path
        pathLength="1"
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse 70% 60% at 50% 50%, rgba(99,102,241,0.22) 0%, rgba(99,102,241,0.09) 45%, transparent 75%)',
      ...
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32, animation: 'sp-enter 0.95s cubic-bezier(0.22,1,0.36,1) 0.25s both' }}>
        ...
        <div style={{ position: 'relative', width: 104, height: 104, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <svg style={{ position: 'absolute', top: '50%', left: '50%', overflow: 'visible', pointerEvents: 'none', animation: 'sf-orbit-cw 6s linear infinite' }} width="0" height="0">
            <circle cx="0" cy="0" r="62" stroke="rgba(99,102,241,0.5)" strokeWidth="1.5" fill="none"
          ...
          <svg style={{ position: 'absolute', top: '50%', left: '50%', overflow: 'visible', pointerEvents: 'none', animation: 'sf-orbit-ccw 10s linear infinite' }} width="0" height="0">
            <circle cx="0" cy="0" r="72" stroke="rgba(99,102,241,0.28)" strokeWidth="1" fill="none"
          ...
          <div style={{
            ...
            boxShadow: '0 0 0 1px rgba(99,102,241,0.3), 0 0 0 4px rgba(99,102,241,0.06), 0 20px 48px rgba(0,0,0,0.75)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
            <span style={{
              fontSize: 46, fontWeight: 900, color: '#E9EAF0',
            ...
            <span style={{
              ...
              background: 'linear-gradient(130deg, #6366F1 20%, #818CF8 100%)',
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
            }}>Flow</span>
          </div>

          {/* Divider */}
          <div style={{ width: 48, height: 1, background: 'linear-gradient(90deg, transparent, rgba(99,102,241,0.45), transparent)' }} />
      ...
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 2, background: 'rgba(255,255,255,0.025)' }}>
        <div className="sf-bar" style={{ height: '100%', background: 'linear-gradient(90deg, transparent, #6366F1, #a855f7, #818CF8, transparent)', borderRadius: 2 }} />
      </div>
...
function BetaPopup({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md">
      <div className="bg-[#080610] border border-[#6366F1]/20 rounded-2xl p-8 w-full max-w-md shadow-2xl shadow-[#6366F1]/10 text-center space-y-5 anim-scale-in">
        {/* Logo + title */}
        ...
        <button
          onClick={onClose}
          style={{ background: 'linear-gradient(130deg,#6366F1,#818CF8)', border: 'none' }}
          className="w-full text-white font-bold py-3 rounded-xl text-sm hover:opacity-90 active:scale-[0.98] transition-all shadow-lg shadow-[#6366F1]/30"
        >
...
function AiModelPopup({ onClose }: { onClose: () => void }) {
  const CATS = [
    { name: 'COSPLAY',        bg: 'linear-gradient(160deg,#1a0a2e 0%,#2d1155 60%,#0d0118 100%)', accent: '#6366F1' },
    ...
    { name: 'LIFESTYLE',      bg: 'linear-gradient(160deg,#0f0f1a 0%,#1e1440 60%,#060610 100%)', accent: '#6366F1' },
  ]
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 22 }}>
          <div>
            <div style={{
              ...
              <span style={{ fontSize: 9, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.14em', color: '#6366F1' }}>Bientôt</span>
            </div>
            <div>
        ...
        <button
          ...
          style={{
            ...
            background: 'linear-gradient(130deg, #4F46E5, #db2777)',
...
const PublishHub     = lazyWithReload(() => import('@/pages/PublishHub').then(m => ({ default: m.PublishHub })))
const PhotoPosting   = lazyWithReload(() => import('@/pages/PhotoPosting').then(m => ({ default: m.PhotoPosting })))
...
function AppContent({ user }: { user: User }) {
  ...
  const content = (() => {
    switch (page) {
      ...
      case 'publishhub':   return <PublishHub  onNavigate={handleNavigate} />
      case 'photoposting': return <PhotoPosting user={user} />
