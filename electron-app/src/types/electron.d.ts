...
interface ElectronAPI {
  ...
  runFfmpegMixOverlay: (opts: { sourcePath: string; caption: string; position: 'top' | 'middle' | 'bottom' | 'custom'; fontSize: number; fontColor: string; posX?: number; posY?: number; gpsSpoof?: boolean; gpsCity?: string; preset?: string; dateDays?: number; audioStoragePath?: string; audioPath?: string; captionStyle?: 'outline' | 'snapchat' }) =>
