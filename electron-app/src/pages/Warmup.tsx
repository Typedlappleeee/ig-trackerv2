                  ...
                  return (
                    <button key={phone.id} onClick={() => togglePhone(phone.id)}
                      ...
                      <div style={{
                        ...
                        border: `1.5px solid ${sel ? '#8b5cf6' : 'rgba(139,92,246,0.25)'}`,
            ...
            {jobShowing && (
              <div className="sf-card anim-slide-up" style={{ overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  background: running ? 'rgba(139,92,246,0.04)' : 'transparent',
                }}>
                    ...
                    {running && (
                      <div style={{ position: 'relative', width: 28, height: 28, flexShrink: 0 }}>
                        ...
                        <div style={{
                          ...
                          background: 'rgba(139,92,246,0.14)', border: '1px solid rgba(139,92,246,0.35)', color: 'var(--accent-glow)',
                        }}>
                ...
                <div style={{ padding: '10px 14px', display: 'flex', flexDirection: 'column', gap: 6, maxHeight: '44vh', overflowY: 'auto' }}>
                  {jobs.map(job => {
                    const borderColor = job.status === 'done' ? 'rgba(34,197,94,0.5)'
                      ...
                      : job.status === 'running' ? 'rgba(139,92,246,0.6)'
                    ...
                    return (
                      <div key={job.phone.id} style={{
                        ...
                        background: job.status === 'running' ? 'rgba(139,92,246,0.04)' : 'transparent',
                      }}>
                          ...
                          <div style={{
                            ...
                            {job.logs.slice(-4).map((l, i) => (
                              <p key={i} style={{ fontSize: 10, fontFamily: 'monospace', color: 'var(--text-4)', lineHeight: 1.5 }}>
                                <span style={{ color: 'rgba(139,92,246,0.4)', marginRight: 4 }}>›</span>{l}
                              </p>
                            ))}
                          </div>
                        )}
                ...
                <div className="sf-card" style={{ overflow: 'hidden' }}>
                  <div style={{ padding: '14px 18px', display: 'flex', alignItems: 'center', gap: 10, borderBottom: '1px solid var(--border)' }}>
                    <div style={{
                      ...
                      background: 'rgba(139,92,246,0.12)', border: '1px solid rgba(139,92,246,0.22)', color: 'var(--accent-glow)',
                    }}>
                      <IconKey size={14} />
                    </div>
                    <div>
                            ...
                            <div>
                              <input
                                ...
                                style={{
                                  ...
                                  borderColor: cred.totpSecret ? 'rgba(139,92,246,0.45)' : undefined,
                                  background: cred.totpSecret ? 'rgba(139,92,246,0.07)' : undefined,
                                  color: cred.totpSecret ? '#c4b5fd' : undefined,
                                }}
                              />
                              {cred.totpSecret && (
                                <p style={{ fontSize: 10, fontFamily: 'monospace', marginTop: 4, paddingLeft: 2, display: 'flex', alignItems: 'center', gap: 4, color: 'rgba(139,92,246,0.7)' }}>
                ...
                <div className="sf-card" style={{ overflow: 'hidden' }}>
                  ...
                  <div className="anim-stagger" style={{ padding: '18px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <div>
                      ...
                      {editPicFile && (
                        <p style={{ fontSize: 10, marginTop: 4, fontFamily: 'monospace', display: 'flex', alignItems: 'center', gap: 4, color: 'rgba(139,92,246,0.7)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }} className="anim-slide-up">
                ...
                <div className="sf-card" style={{ overflow: 'hidden' }}>
                  <div style={{ padding: '14px 18px', display: 'flex', alignItems: 'center', gap: 10, borderBottom: '1px solid var(--border)' }}>
                    <div style={{
                      width: 28, height: 28, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center',
                      background: 'rgba(236,72,153,0.12)', border: '1px solid rgba(236,72,153,0.22)', color: '#ec4899',
                    }}>
                      <IconFlame size={14} />
                    </div>
                    <div>
                        ...
                        {[0, 5, 10, 15, 20, 30].map(m => (
                          <button key={m} onClick={() => setBrowseMinutes(m)}
                            ...
                            style={{
                              ...
                              ...(browseMinutes === m
                                ? { background: 'linear-gradient(140deg, #7C3AED, #6D28D9)', color: '#fff', boxShadow: '0 0 18px -4px rgba(124,58,237,0.55)' }
                        ...
                        {([
                          ...
                          return (
                            <div key={key} style={{
                              ...
                              background: value && !disabled ? 'rgba(139,92,246,0.06)' : 'rgba(255,255,255,0.02)',
                              border: `1px solid ${value && !disabled ? 'rgba(139,92,246,0.2)' : 'var(--border)'}`,
                            }}>
