          ...
          <div className="space-y-5 max-w-3xl mx-auto pt-6 anim-stagger">
            ...
            {phase === 'processing' && (
              <div className="sf-card p-10 text-center space-y-4">
                <div className="relative mx-auto w-16 h-16">
                  <div className="absolute inset-0 rounded-full animate-ping opacity-20" style={{ background: '#6366F1' }} />
                  <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)' }}>
                    <Spinner size="lg" />
                  </div>
                </div>
            ...
            {phase === 'ready' && videoPath && (
              <div className="grid grid-cols-2 gap-4">
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(130deg,#6366F1,#6366F1)' }}
                >
            ...
            {phase === 'idle' && (
              <div className="sf-empty flex-col gap-4 py-16">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center sf-anim-scale-spring" style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.15)' }}>
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#818CF8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"/><circle cx="7.5" cy="7.5" r=".5" fill="currentColor"/>
                  </svg>
                </div>
