      ...
      <div className="flex-shrink-0 px-8 pt-7 pb-6" style={{ borderBottom: '1px solid var(--border)' }}>
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 sf-anim-scale-spring"
            ...
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#c4b5fd" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <button
                ...
                style={postFilter === f.k
                  ? f.k === 'replied'
                    ...
                    : { background: 'rgba(139,92,246,0.12)', color: 'var(--accent-glow)', border: '1px solid rgba(139,92,246,0.25)' }
            ...
            {loading ? (
              ...
              <button
                ...
                style={selectedPost?.id === p.id
                  ? { background: 'rgba(139,92,246,0.08)', borderBottom: '1px solid var(--border)' }
          ...
          <div className="flex-shrink-0 px-6 py-4 space-y-4" style={{ borderTop: '1px solid var(--border)', background: 'rgba(0,0,0,0.15)' }}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="sf-tabs">
                <button
                  ...
                  style={replyMode === 'ai'
                    ? { background: 'rgba(139,92,246,0.15)', color: 'var(--accent-glow)', border: '1px solid rgba(139,92,246,0.3)' }
                    : {}}
                >
            ...
            {replyMode === 'manual' && (
              <div className="space-y-3">
                <div className="sf-card p-3 flex items-center gap-3" style={{ borderColor: 'rgba(139,92,246,0.2)' }}>
                ...
                <label className="sf-card p-3 flex items-center gap-3 cursor-pointer" style={{ borderColor: useGeelark ? 'rgba(139,92,246,0.3)' : undefined }}>
                  <input
                    type="checkbox"
                    checked={useGeelark}
