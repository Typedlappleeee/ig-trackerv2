      ...
      <div className="w-full max-w-lg space-y-6 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: 'rgba(233,234,240,0.5)' }}>Une seule chose pour commencer.</p>
          </div>
        </div>
        ...
        {step === 1 && (
          <div className="glass-card rounded-2xl p-6 space-y-5">
            ...
            <div className="rounded-xl p-4 space-y-2" style={{ background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.1)' }}>
              <p className="font-semibold text-xs uppercase tracking-wider" style={{ color: 'rgba(233,234,240,0.5)' }}>Comment obtenir ton token :</p>
        ...
        {step === 2 && (
          <div className="glass-card rounded-2xl p-6 space-y-5 text-center">
            ...
            <div className="text-left rounded-xl p-4 space-y-1 text-xs" style={{ background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.1)', color: 'rgba(233,234,240,0.6)' }}>
              <p className="font-semibold text-xs uppercase tracking-wider mb-2" style={{ color: 'rgba(233,234,240,0.5)' }}>Configurer plus tard dans Paramètres :</p>
