              ...
              <>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-white text-sm font-bold">Payer via Telegram</div>
                    <div className="text-[11px] mt-0.5" style={{ color: '#29b6f6' }}>Contacte @typedlapple</div>
                  </div>
                </a>

                <p className="text-[10px] text-[#4a3f7a] text-center">
                  Stripe ou Telegram — annulable à tout moment
                </p>
              </>
            ) : tab === 'license' ? (
              <>
