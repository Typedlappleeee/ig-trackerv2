...
export default function Phones({ theme, infra, user, org }: {
  ...
  const load = useCallback(async () => {
    ...
    let query = supabase
      .from('phones')
      .select('id,phone_name,ig_username,ig_status,group_name,status,total_views,pp_url,last_post_at,account_state')
      .order('phone_name')
    query = currentOrg
    ...
    <div style={{ animation: 'aIn .3s cubic-bezier(0.16,1,0.3,1) both' }}>
              ...
              return (
                ...
                >
                  ...
                  <span style={{ display: 'flex', justifyContent: 'flex-end', gap: 5 }} onClick={e => e.stopPropagation()}>
                    <Btn theme={theme} sm tone="ghost" icon="M5 3l14 9-14 9z" label="Démarrer" />
      ...
      {sel.size > 0 && (
        <div style={{
          ...
          <Btn label="Démarrer" theme={theme} sm icon="M5 3l14 9-14 9z" />
